...
"""
МОИ КОММЕНТАРИИ
- Я не стал делать запрос ввода пользвоателя в Задании 2 из сообраений удобства. В папке с ДЗ создатутся
...
- В итоговом print'e я вывел результаты с использованием concurrent.futures и без него для сравнения. Почему-то с 
